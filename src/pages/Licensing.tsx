        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-xl text-foreground/70">
              Amplify your content reach and build a sustainable ecosystem for creators
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Licensing Benefits</h2>
            <p className="text-xl text-foreground/70">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <GlassmorphicCard className="p-6 h-full transition-transform duration-300 hover:scale-105 hover:shadow-xl">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold mb-3">Viral Video Creation</h3>
                <p className="text-foreground/70">
                  Work with top creators to bring viral videos to life and expand your reach
                </p>
              </div>
            </GlassmorphicCard>
          </div>
