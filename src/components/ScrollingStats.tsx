...
import { GeometricShape, GradientBlob, FloatingElement } from "./ParallaxElements";
...
export const ScrollingStats: React.FC = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-b from-background to-blue-50/30 overflow-hidden relative">
      {/* Decorative elements */}
      <GradientBlob 
        position="top-10 right-0" 
        size="w-[500px] h-[500px]" 
        colors="from-blue-300/10 to-blue-100/5"
      />
      <GradientBlob 
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <motion.div 
            ...
            className="space-y-4"
          >
            {/* Active Claims card - moved to the left */}
            <motion.div 
