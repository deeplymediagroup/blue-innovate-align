        ...
        <div className="max-w-5xl mx-auto rounded-lg border border-blue-200 bg-white overflow-hidden shadow-sm">
          <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            ...
            <div className="relative h-full flex items-center">
              <div className="overflow-hidden rounded-md h-full w-2/3 ml-auto relative">
                <img 
                  src="public/lovable-uploads/cc93ab06-52d9-4bc6-982c-e27b607f63cf.png" 
                  alt="Alan Watts" 
                  className="w-full h-full object-cover"
                />
                <div className="absolute bottom-0 left-0 right-0 py-4 px-5 bg-gradient-to-t from-black/80 via-black/40 to-transparent">
